...
* 시행 착오를 통해 purchase가 1인 경우를 9번 추가 학습 시키기로 하였고, 그에 따른 총 학습 횟수는 위의 바그래프와 같이 나왔습니다.
...
* 결과의 confusion matrix는 위와 같이 나왔으며, 전체 예측률은 0.8245, 구매하는 고객에 대한 예측률은 0.3641로 나왔습니다.
